/* Layout configuration for sm_td tests: SMTD_ENABLE_QMK_TAPHOLD with raw QMK MT()/LT() keycodes */
...
uint16_t const keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L0] = { L0_KC0, MT(MOD_LCTL, TAP_KC1), LT(L1, TAP_KC2), MT(MOD_RCTL, TAP_KC3), L0_KC4, L0_KC5, L0_KC6, L0_KC7, L0_KC8, },
