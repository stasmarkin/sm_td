# QMK-native test for sm_td: SMTD_ENABLE_QMK_TAPHOLD with raw MT()/LT() keycodes,
# compiled against the REAL quantum pipeline (action.c, action_tapping.c, deferred_exec.c).
